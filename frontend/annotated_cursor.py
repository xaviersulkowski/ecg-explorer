...
class AnnotatedCursor(Cursor):
    ...
    **cursorargs : `matplotlib.widgets.Cursor` properties
    ...
    def onmove(self, event):
        ...
        plotpoint: Optional[list[Any]] = None
        ...
        if plotpoint is not None:
            ...
            # Custom, apply fs (sampling frequency) to match to seconds that are visible on the plot
            plotpoint = (plotpoint[0] / self.fs, plotpoint[1])
