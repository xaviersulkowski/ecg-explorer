...
class Span:
    ...
    def set_visible(self, visibility: bool):
        if self._span_artist is None:
            logging.warning(f"Span {self}, does not have span artist created. Ignoring `set_visible`...")
            return
    ...
    def highlight(self):
        if self._span_artist is None:
            logging.warning(f"Span {self}, does not have span artist created. Ignoring `highlight`... ")
            return
    ...
    def remove_highlight(self):
        if self._span_artist is None:
            logging.warning(f"Span {self}, does not have span artist created. Ignoring `remove_highlight`...")
            return
    ...
    def remove_artist(self):
        if self._span_artist is None:
            logging.warning(f"Span {self}, does not have span artist created. Ignoring `remove`...")
            return
